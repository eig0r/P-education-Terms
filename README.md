...
Where P-Eduecation Pty Ltd are a Data Processor, and act on behalf of a data controller (such as P-EduecationCloud) any requests received by P-Eduecation Pty Ltd will be passed on to the Data Controller.
